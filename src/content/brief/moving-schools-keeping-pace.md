...
> **For information only.** This article is an editorial orientation resource. It does not constitute educational advice. School policies, curriculum structures and admission requirements vary and change. Always verify current information directly with individual schools and with your organisation's HR before making schooling decisions.
...
The problem is that the IB is not a uniform product. Schools are authorised to offer IB programmes, but they implement them differently. The MYP in particular is assessed school-by-school rather than through a global external exam, which means that moving mid-MYP between two IB schools does not guarantee a seamless transition. Language of instruction, the balance between subjects, and the school's interpretation of the curriculum can all differ meaningfully.

For families moving between different curriculum systems, the friction is sharper. A child mid-way through the French Baccalauréat who moves to a city where the only available French school has a waiting list of two years has a real problem. A student in the American system arriving in Europe at Grade 11 needs to consider carefully how their transcript will read to a US college, particularly if the new school operates on a different grading scale or does not offer Advanced Placement.

British curriculum families face a specific constraint at GCSE level. The two-year GCSE programme normally runs from Year 10 to Year 11, with external examinations at the end. A move mid-way through that cycle, to a school that does not offer the same subject combinations or examination boards, can disrupt the trajectory significantly.

None of this is unsolvable, and international schools deal with mid-year and mid-cycle arrivals regularly. Most have systems for assessing incoming students and placing them appropriately. The practical question is not whether a school can accommodate a transfer, but whether the transfer creates a gap in the child's academic record that matters for what comes next.
...
- [IB Organisation: About the IB](https://www.ibo.org/about-the-ib/)
- [IB Organisation: Authorised schools directory](https://www.ibo.org/programmes/find-an-ib-school/)
- [UN Staff Council: Education grant information](https://www.ungeneva.org/en/human-resources/education-grant)
- [European Commission: Education allowance for EU staff](https://ec.europa.eu/info/jobs-european-commission/working-us/salary-and-benefits_en)
