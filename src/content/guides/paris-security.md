...
The primary targets are wallets, passports, mobile phones and luxury watches. Thieves typically work in groups. The US Embassy's [safety guidance for Paris](https://fr.usembassy.gov/services/lost-and-found-property-in-paris/safety-advice-for-paris/) notes that distraction is the standard technique: one person engages the target while another takes the item. Common scenarios include someone asking you to sign a petition, the "dropped ring" approach, and crowding at metro turnstiles.
...
Monitor [gouvernement.fr](https://www.gouvernement.fr) and your mission's own security communications for advance notice of major demonstrations.
...
| Number | Service |
|--------|---------|
| **112** | European emergency number; routes to the appropriate service, multilingual operators available |
| **15** | SAMU: medical emergencies and ambulance dispatch |
| **17** | Police Nationale: crimes in progress, immediate threats |
| **18** | Sapeurs-Pompiers: fire, rescue, accidents |

The government app [SAIP](https://www.interieur.gouv.fr/Le-ministere/Actualites/Les-dossiers-du-moment/Plan-VIGIPIRATE/L-application-SAIP) (Système d'Alerte et d'Information des Populations) from the Ministry of the Interior provides real-time crisis alerts. It is worth having installed.
...
- [Gouvernement.fr: Vigipirate (current level)](https://www.gouvernement.fr/risques/vigipirate)
- [Ministère de l'Intérieur: Application SAIP](https://www.interieur.gouv.fr/Le-ministere/Actualites/Les-dossiers-du-moment/Plan-VIGIPIRATE/L-application-SAIP)
